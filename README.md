...
Dieses Projekt ist jetzt located in `ragbook_local/` (moved from repository root).
...
- `slack_rag_assistant/` — Slack RAG Assistant (independent project).
- `udacity-project-apply-lightweight-fine-tuning/` — Udacity project workspace.
